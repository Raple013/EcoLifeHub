<section class="space-y-6">
    <header>
        <h2 class="font-display text-xl text-forest-800">{{ __('Delete Account') }}</h2>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-8">
            ...
            <h2 class="font-display text-xl text-forest-800">{{ __('Are you sure you want to delete your account?') }}</h2>
