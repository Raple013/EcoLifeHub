{{-- Ganti h-[100dvh] menjadi h-full agar sinkron dengan pembungkus luarnya --}}
<aside class="w-64 shrink-0 bg-white/95 backdrop-blur-sm border-r border-sage-200 flex flex-col h-full z-10 overflow-y-auto">
    <div class="p-6 border-b border-sage-100 shrink-0">
